...
/**
 * Registers every weapon, ammo type, and gadget for the GoldenEye 64 mod,
 * plus a creative-tab item group that contains them all.
 */
public final class ModItems {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(GROUP_KEY).register(entries -> {
            // Pistols
            entries.add(PP7);
            entries.add(PP7_SILENCED);
            entries.add(DD44);
            entries.add(COUGAR_MAGNUM);
            // SMGs
            entries.add(KLOBB);
            entries.add(ZMG);
            entries.add(D5K);
            entries.add(RCP90);
            // Rifles
            entries.add(KF7_SOVIET);
            entries.add(AR33);
            entries.add(SNIPER_RIFLE);
            // Shotguns
            entries.add(SHOTGUN);
            entries.add(AUTO_SHOTGUN);
            // Special
            entries.add(GOLDEN_GUN);
            // Ammo
            entries.add(AMMO_9MM);
            entries.add(AMMO_RIFLE);
            entries.add(AMMO_MAGNUM);
            entries.add(AMMO_SHELLS);
            entries.add(AMMO_SNIPER);
            entries.add(AMMO_GOLDEN);
            // Gadgets
            entries.add(PROXIMITY_MINE);
            entries.add(REMOTE_MINE);
            entries.add(TIMED_MINE);
